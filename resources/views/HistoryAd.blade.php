...
<head>
    ...
    <title>{{config('app.name')}}  | {{__(' HistoryAD')}}</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">
...
<div id="app">
    ...
    <body>
    <br><br><br>
    <center><h1 style="color:White"> Meeting History</h1></center><br><br>
    <div class="jumbotron jumbotron-fluid">

        <div class="container">
            <h6 class="display-4">Show Meeting History </h6>
            <p class="lead"> </p>
            <hr class="my-4">
            <table class="table table-striped" >
                ...
                <tr>
                    ...
                    <th scope="col">Meeting Was About</th>
