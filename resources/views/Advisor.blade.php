...
<head>
    ...
    <title>{{config('app.name')}}  | {{__(' Advisor Profile')}}</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">
...
<div id="app">
    ...
    <br><br><br><br><br><div id="container" class="container">
        <div class="input-group mb-2 date-center">
            ...
            <ul class="list-group-item">
                ...
                <li class="list-group-item">  <h3><a href="#">Office Hours</a></li></h2>
                <li class="list-group-item">  <h3><a href="#">Office Floor and Number</a></li></h2>
                 <li class="list-group-item">  <h3><a href="#">Advisor Email</a></li></h2>
                <li class="list-group-item"> <h3><a href="http://172.16.2.9/meetings">Setup meeting</a></h3></ul>
