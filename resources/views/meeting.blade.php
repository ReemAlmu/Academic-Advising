...
<head>
    ...
    <title>{{config('app.name')}}  | {{__(' MeetingAD')}}</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">
...
<br><br><br>
            ...
            <a class="btn btn-primary" href="http://172.16.2.9/meet" role="button">Setup Meeting</a>
            <a class="btn btn-primary" href= "http://172.16.2.9/HistoryAd" role="button">Meeting History</a>
            <a class="btn btn-primary" href= "http://172.16.2.9/Report" role="button">Meeting Report</a>
