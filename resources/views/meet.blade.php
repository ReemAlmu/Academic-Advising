...
<head>
    ...
    <title>{{config('app.name')}}  | {{__(' Advisor Meeting')}}</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">
...
<body>
<br><br>
<center><h3>Setup a new meeting</h3></center>
<br><br><br><center>

    {{--<form class="form-inline">--}}
    <br>
    <center>
        <form ction="https://www.seu.edu.sa/">
            <div id="container" class="container">
                <div class="input-group mb-2 text-center">
                    <div class="col-auto">
                        <div class="input-group-prepend">
                            <div> <label class="input-group-text" for="inputGroupSelect01"> Select Meeting Type : </label><br></div>
                            <select class="custom-select" id="inputGroupSelect01">
                                <option selected>Choose...</option>
                                <option value="1">Face To Face</option>
                                <option value="2">Virtual</option>
                            </select>
                        </div></div></div></div></form></center></center>
            ...
            <div id="container" class="container">
                <div class="input-group mb-2 date-center">
                    <div class="col-auto">
                        <div class="input-group-prepend">
                            <div class="col-10">
                                <div> <label class="input-group-text" for="inputGroupSelect01"> Date:</label></div>
                                <br>
                                <div> <input class="form-control" type="date" value="2020-06-25" id="example-date-input"></div>
                            </div></div>
                    </div></div></div></center>
                      <div class="form-group row">
                          <div id="container" class="container">
                              ...
                              <div class="col-auto">
                                  <div class="input-group-prepend">
                                      <div class="col-10">
                                          <div> <label class="input-group-text" for="inputGroupSelect01"> Time:</label></div>
                                          <br>
                                         <div> <input class="form-control" type="time" value="13:45:00" id="example-time-input"></div>
